...
description: >
  Extract PDFs, scans, images, Word documents, PowerPoint files, and web pages to Markdown, HTML, LaTeX, or DOCX with MinerU. Use for PDF-to-Markdown conversion, OCR, table and formula extraction, academic-paper parsing, web extraction, or batch document processing. Prefer flash-extract for quick token-free parsing and precision or VLM modes for complex layouts.
